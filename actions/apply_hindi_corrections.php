...
$map = $_POST['mapped'];
echo "<h3>🔎 Preview Corrections (" . count($dataRows) . " rows)</h3><table><tr>";
...
if ($apply === 'update' && $confirm) {
    echo "<div class='alert'>✅ Applied $updated updates to database.</div>";
}
