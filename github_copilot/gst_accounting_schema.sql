CREATE DATABASE IF NOT EXISTS `gst_app_github_copilot` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `gst_app_github_copilot`;
SET sql_notes=0;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017  /*!50003 TRIGGER trg_generate_purchase_invno
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017  /*!50003 TRIGGER bi_invoices_party_scope
BEFORE INSERT ON invoices
FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017  /*!50003 TRIGGER bi_invoices_autoserial
BEFORE INSERT ON invoices
FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017  /*!50003 TRIGGER bu_invoices_party_scope
