...
-- Dump completed on 2025-09-28  8:11:49
...
--
-- Table structure for table `CSS_History`
--
...
--
-- Table structure for table `JS_History`
--
...
--
-- Table structure for table `gst_hsn_rates`
--
...
--
-- Table structure for table `purchase_invoice_staging`
--
...
--
-- Table structure for table `purchase_staging`
--
...
--
-- Table structure for table `staging_purchase_invoice`
--
...
--
-- Temporary table structure for view `v_pages_to_tables`
--
...
--
-- Final view structure for view `v_pages_to_tables`
--
...
--
-- Temporary table structure for view `v_tables_to_pages`
--
...
--
-- Final view structure for view `v_tables_to_pages`
--
