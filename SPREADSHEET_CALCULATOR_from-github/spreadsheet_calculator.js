...
function savePreview() {
  const blob = new Blob([document.getElementById('clipboardPreview').value], { type: 'text/plain' });
  const a = document.createElement('a');
  a.href = URL.createObjectURL(blob);
  a.download = 'clipboard_preview.txt';
  a.click();
}

// Save entire sheet to file (TSV)
function saveSheet() {
  ...
  const a = document.createElement('a');
  a.href = URL.createObjectURL(blob);
  a.download = 'spreadsheet_data.txt';
  a.click();
}
